...
//    func executeGraphQL(query: String, url: String, headers: [String: String], completion: @escaping (Result<Data, Error>) -> Void)

    func executeGraphQL<T: Decodable>(query: String, url: String, headers: HTTPHeaders, completion: @escaping (Result<T, Error>) -> Void) 
